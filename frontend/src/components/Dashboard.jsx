      ...
      try {
        ...
        setDealData({
          ...
          metrics: {
            ...
            debt: "$40M",
            cashFlow: "$12M",
            valuationMultiple: "12x",
            debtEquityRatio: "0.65",
            profitMargin: "18%"
          },
          summary: "Tech Innovations Inc. shows strong YoY growth of 15%, driven by expanding operations in APAC and North America. Healthy EBITDA margin of 20%, though debt levels remain slightly elevated compared to industry averages. The company has demonstrated consistent revenue growth over the past 4 quarters with improving operational efficiency.",
          risks: [
            "High leverage ratio compared to industry peers",
            "Declining cash flow in past 2 quarters",
            "Dependency on key customer accounts (30% revenue concentration)"
          ],
          opportunities: [
          ...
          revenueData: [
            { period: "Q1 2024", revenue: 28 },
            { period: "Q2 2024", revenue: 30 },
            { period: "Q3 2024", revenue: 32 },
            { period: "Q4 2024", revenue: 35 }
          ],
          ebitdaData: [
            { period: "Q1 2024", ebitda: 5.6, margin: 20 },
            { period: "Q2 2024", ebitda: 6.0, margin: 20 },
            { period: "Q3 2024", ebitda: 6.4, margin: 20 },
            { period: "Q4 2024", ebitda: 7.0, margin: 20 }
          ]
        });
        setLoading(false);
      } catch (error) {
      ...
      <main style={{ maxWidth: '1400px', margin: '0 auto', padding: '2.5rem 3rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ display: 'flex', gap: '2rem', fontSize: '0.875rem', color: '#999999' }}>
                ...
                <span>📅 {dealData.dateUploaded}</span>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: '2.5rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            {/* Metrics Cards */}
            <MetricCard icon="💰" label="Revenue" value={dealData.metrics.revenue} />
            <MetricCard icon="📈" label="Revenue Growth" value={dealData.metrics.revenueGrowth} positive />
            <MetricCard icon="⚡" label="EBITDA" value={dealData.metrics.ebitda} />
            <MetricCard icon="📉" label="Debt" value={dealData.metrics.debt} />
            <MetricCard icon="💵" label="Cash Flow" value={dealData.metrics.cashFlow} />
            <MetricCard icon="📐" label="Valuation Multiple" value={dealData.metrics.valuationMultiple} />
            <MetricCard icon="📊" label="Debt/Equity Ratio" value={dealData.metrics.debtEquityRatio} />
