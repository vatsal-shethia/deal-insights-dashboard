...
//   const handleFileUpload = async (deal, file) => {
//     setLoading(true);
//     // Implement file upload logic
//     // const formData = new FormData();
//     // formData.append('file', file);
//     // const response = await fetch('/api/deals/upload', { method: 'POST', body: formData });
//     setLoading(false);
//   };
...
//   const mergeChartData = () => {
//     if (!dealA || !dealB) return [];
//     return dealA.revenueData.map((item, idx) => ({
//       period: item.period,
//       dealA: item.dealA,
//       dealB: dealB.revenueData[idx].dealB
//     }));
//   };
...
//             <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
//               <div style={{ backgroundColor: 'white', border: '1px solid #e5ddd5', borderRadius: '12px', padding: '2rem' }}>
//                 <h3 style={{ marginBottom: '1rem' }}>Deal A</h3>
//                 <select style={{ width: '100%', padding: '0.75rem', borderRadius: '6px', border: '1px solid #e5ddd5' }}>
...
//               </div>
//               <div style={{ backgroundColor: 'white', border: '1px solid #e5ddd5', borderRadius: '12px', padding: '2rem' }}>
//                 <h3 style={{ marginBottom: '1rem' }}>Deal B</h3>
//                 <select style={{ width: '100%', padding: '0.75rem', borderRadius: '6px', border: '1px solid #e5ddd5' }}>
//                   <option>Select a deal...</option>
//                   {previousDeals.map(deal => (
//                     <option key={deal.id} value={deal.id}>{deal.name}</option>
...
//             <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
//               <div style={{ backgroundColor: 'white', border: '1px solid #e5ddd5', borderRadius: '12px', padding: '2rem' }}>
//                 <h3 style={{ marginBottom: '1rem' }}>Upload Deal A</h3>
//                 <input type="file" accept=".csv,.pdf" onChange={(e) => setFileA(e.target.files[0])} />
//               </div>
//               <div style={{ backgroundColor: 'white', border: '1px solid #e5ddd5', borderRadius: '12px', padding: '2rem' }}>
//                 <h3 style={{ marginBottom: '1rem' }}>Upload Deal B</h3>
//                 <input type="file" accept=".csv,.pdf" onChange={(e) => setFileB(e.target.files[0])} />
//               </div>
//             </div>
//           )}
...
//           <div style={{ display: 'flex', gap: '1rem' }}>
//             <button
//               onClick={() => { setDealA(null); setDealB(null); }}
//               style={{
//                 padding: '0.625rem 1.5rem',
//                 backgroundColor: 'white',
//                 border: '1px solid #e5ddd5',
