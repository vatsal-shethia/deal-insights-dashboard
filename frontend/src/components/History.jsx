...
function History() {
  ...
  //       try {
  //         localStorage.setItem("deals", JSON.stringify(mock));
  //       } catch {}
  //     }
  //   } catch (error) {
  ...
  const getMockDeals = () => [
    {
      ...
      industry: "Technology",
      summary:
        "Strong YoY growth of 15%, driven by expanding operations in APAC. Healthy EBITDA margin of 20%, though debt levels remain slightly elevated.",
      tags: ["Tech", "Growth"],
    ...
    },
    {
      ...
      industry: "Healthcare",
      summary:
        "Moderate growth with focus on market consolidation. Lower debt levels and strong operational efficiency, but facing competitive pressure.",
  ...
  const handleBulkDelete = () => {
    if (window.confirm(`Delete ${selectedDeals.length} selected deals?`)) {
      ...
      setDeals((prev) =>
        prev.filter((deal) => !selectedDeals.includes(deal.id))
      );
      setSelectedDeals([]);
    }
  };
            ...
            >
              <button
                ...
                style={{
                  ...
                  backgroundColor:
                    viewMode === "card" ? "#f5f1ed" : "transparent",
                  border: "none",
                  borderRadius: "4px",
                  cursor: "pointer",
                  color: "#1a1a1a",
              ...
              <button
                ...
                style={{
                  padding: "0.5rem 0.75rem",
                  backgroundColor:
                    viewMode === "table" ? "#f5f1ed" : "transparent",
                  border: "none",
                  borderRadius: "4px",
                  cursor: "pointer",
                  color: "#1a1a1a",
    ...
    >
      ...
      >
        <div>
          ...
          <p style={{ fontSize: "1rem", fontWeight: "500", color: "#1a1a1a" }}>
            ${deal.revenue}M
          </p>
        </div>
        <div>
